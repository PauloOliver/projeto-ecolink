...
import { getCurrentUser } from "../services/auth"; // usa o mesmo do login
...
export function Jumbotron() {
  ...
  return (
    <section className="bg-center bg-no-repeat bg-cover bg-[url('./assets/img-fundo.png')] bg-green-200 bg-blend-multiply">
      <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-[#11111F] md:text-5xl lg:text-6xl">
          Conectando pessoas por um mundo melhor!
        </h1>
        <p className="mb-8 text-lg font-normal text-[#11111F] lg:text-xl sm:px-16 lg:px-48">
          ...
          culpa praesentium eligendi perspiciatis ullam dignissimos exercitationem
          quam. Sit molestias hic illo! Hic aspernatur ipsam earum minima provident
          veniam officia.
        </p>
